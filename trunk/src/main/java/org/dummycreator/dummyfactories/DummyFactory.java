...
public abstract class DummyFactory<T> {
	...
	/**
	 * Creates a new instance of: the requested type, a sub type of the requested type or, if the requested type is an interface definition,
	 * a suitable implementation. Should return <code>null</code> if nothing can be found.
	 * <p>
	 ...
	 * them in the given <code>exceptions</code> list.
	 * 
	 ...
	 */
	public abstract T createDummy(List<Exception> exceptions, ClassBindings classBindings);
}