...
public class RandomPrimitiveFactoryTest {
	...
	public void testCreateLoremIpsumObject() {
		...
		assertThat(new RandomPrimitiveFactory<>(int.class).createLoremIpsumObject()).isEqualTo(Integer.valueOf(5));
		assertThat(new RandomPrimitiveFactory<>(double.class).createLoremIpsumObject()).isEqualTo(Double.valueOf(5.5));
		assertThat(new RandomPrimitiveFactory<>(Integer.TYPE).createLoremIpsumObject()).isEqualTo(Integer.valueOf(14));
		assertThat(new RandomPrimitiveFactory<>(Double.TYPE).createLoremIpsumObject()).isEqualTo(Double.valueOf(10.55));
	}
